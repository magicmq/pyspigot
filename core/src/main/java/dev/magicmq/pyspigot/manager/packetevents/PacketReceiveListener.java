...
public class PacketReceiveListener extends ScriptPacketListener {
     ...
     */
    public PacketReceiveListener(Script script, PyCallable function, PacketTypeCommon packetType) {
    ...
    /**
     * Prints a representation of this PacketReceiveListener in string format, including the packet type listened to by the listener
     * @return A string representation of the PacketReceiveListener
     */
    @Override
    public String toString() {
        ...
        return String.format("%s, Listener Type: PacketReceiveListener]", superString);
    }
}
