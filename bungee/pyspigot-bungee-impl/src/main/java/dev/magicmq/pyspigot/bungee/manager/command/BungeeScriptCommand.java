...
public class BungeeScriptCommand extends Command implements TabExecutor, ScriptCommand {
    ...
    public void execute(CommandSender sender, String[] args) {
        try {
            ...
            ((BungeeAudiences) PyCore.get().getAdventure()).sender(sender).sendMessage(Component.text("An internal error occurred whilst executing this command, please check the console log for details.", NamedTextColor.RED));
        }
    }
