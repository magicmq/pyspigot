...
/**
 * The loader plugin for the BungeeCord platform.  This is the true entry point for PySpigot on BungeeCord.
 */
public class BungeeLoader extends Plugin {

    private static final String JAR_NAME = "pyspigot-bungee-impl.jar";
    private static final String MAIN_CLASS = "dev.magicmq.pyspigot.bungee.PyBungee";
    ...
    public BungeeLoader() {
        ...
        this.plugin = loader.instantiatePlugin(MAIN_CLASS, Plugin.class, this);
    }
