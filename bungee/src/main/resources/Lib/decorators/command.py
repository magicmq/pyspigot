...
def command(name, description='', usage='', aliases=[], permission=None):
    """
    ...
    def _decorator(function):
        ...
        registered_command = command_manager.registerCommand(function, None, name, description, usage, aliases, permission)
